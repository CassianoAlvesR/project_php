...
if ( isset($_POST['logar']) and ($_POST['logar'] == 'Acessar')) {
	...
	if( !empty($_POST['emailLogin']) && !empty($_POST['senhaLogin']) ) {
		...
		// Testa se o email informado existe. Se for igual 0, significa que não há email cadastrado.
		if ( count($resultado) == 0) {
			?>
			<script type="text/javascript">
			...
			if ($usuario -> getusuSenha() != $usuSenha) {
				...
				<?php
			} else { // redireciona o usuário de acordo com o seu perfil cadastrado.
...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8">
				<!-- ConfiguraÃ§Ã£o para tablets. OcuparÃ¡ 8 colunas. -->
				<h3>Registre-se</h3>
				<h5>NÃ£o Ã© usuÃ¡rio?</h5>
				<form name="cadastro" method="post">
					<div class="form-group">
						<label>Nome: </label> <input type="text" class="form-control"
							name="nome" id="nome">
						<!-- classe de formataÃ§Ã£o do Bootstrap -->
					</div>
					...
					<div class="checkbox">
						<label> <input type="checkbox"> Aceito os termos do serviÃ§o. </label>
					</div>
			...
			<div class="col-sm-4">
				<!-- OcuparÃ¡ 4 colunas. Totalizando 12 colunas (8+4) -->
				<h3>Login</h3>
				<h5>(Apenas usuÃ¡rios cadastrados)</h5>
